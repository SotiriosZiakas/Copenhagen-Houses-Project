""" Predict the prices of new houses using the model trained on all of our dataset """

import joblib
from build_features import clean_data_transformer
import pandas as pd

# Load the model we created and trained on all of the dataset

loaded_model = joblib.load('full_trained_model.pkl')
